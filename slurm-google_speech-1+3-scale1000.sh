...
#SBATCH --dependency=afterany:78009

export FEDSCALE_HOME=/nfs-share/ls985/FedScale
DRIVER_SCRIPT=/nfs-share/ls985/FedScale/docker/driver_slurm_multinode.py
YAML_CONFIG=/nfs-share/ls985/FedScale/benchmark/configs/speech/google_speech-multi-1+3-scale1000.yml
